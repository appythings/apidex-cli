...
function createProgram() {
  ...
  cli
    ...
    .description('uploads OpenAPI, MCP, or GraphQL specs to apidex')
  ...
  cli
    ...
    .description(
      'validate OpenAPI, MCP, and GraphQL specs, overlay files, manifest paths, and markdown links (use --check-portal to match products in the portal)',
    )
    .action(async (manifest, command) => {
